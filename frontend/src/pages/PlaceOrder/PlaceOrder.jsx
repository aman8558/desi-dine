    ...
    return(
        <form onSubmit={placeOrder} className="place-order">
           <div className="place-order-left">
              ...
              <input  className='email' required name='email' onChange={onChangeHandler} value={data.email} type="text" placeholder="email address"/>
           ...
           <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                       ...
                       <div className="cart-total-details">
                          <b>Total</b>
                          <b>₹{getTotalCartAmount()===0?0:60+getTotalCartAmount()}</b>
                       </div>
                    </div>
